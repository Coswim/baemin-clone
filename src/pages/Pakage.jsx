...
import { RiHome4Line, RiCoupon2Fill } from 'react-icons/ri'
...
//image
import pakagelogo from '../components/pakage/pakagelogo.png'
// import '../components/pakage/baemin-icons'
    ...
    <PakageWrap>
      <Header>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <img src={pakagelogo} width={'75px'} />
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 15 }}>
          <RiHome4Line size={25} />
          <RxComponent2 size={25} />
          <FiShoppingCart size={25} />
        </div>
      </Header>
      <Address>
        전라북도 전주시 세병로 112 702동 2604호
        <TiArrowSortedDown />
      </Address>
      <NavBar>
        <TopNavElement>
      ...
      <Map
        ...
        level={3}>
        <MapMarker position={location.center}></MapMarker>
        <MarkerClusterer
...
const TopNavElement = styled(NavElement)`
...
const NavScrollElement = styled.div`
  height: 100%;
  display: flex;
  overflow-x: scroll;
  overflow-y: hidden;
